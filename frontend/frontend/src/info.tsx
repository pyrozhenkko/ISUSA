...
import { User, LogIn, LayoutDashboard, Zap, FileText, ArrowRight } from 'lucide-react';
import { Link, useNavigate } from 'react-router-dom';

// 1. ОНОВЛЕННЯ ІНТЕРФЕЙСУ ПРОПСІВ
// Тепер компонент InfoPage приймає лише isAuthenticated
interface InfoPageProps {
     isAuthenticated: boolean; 
    // handleLogin та authStatus видалені, оскільки вони керуються в App.tsx
}
...
    };
    
    // JSX-код залишається без змін (крім заміни authStatus на isAuthenticated)
    return (
